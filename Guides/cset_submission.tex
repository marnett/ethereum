...
A third mistake is more subtle:
\begin{itemize}
\item Players
...
In Figure~\ref{fig:nocrypto}, we show a snippet of the fixed contract that uses commitments. The previous \texttt{player\_input} function is broken up into two phases: in the new \texttt{player\_input} function, each player provides a commitment; after both commitments are received, the \texttt{open} function is used to reveal their commited inputs.
