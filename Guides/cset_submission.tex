...
\end{minted}
\end{mdframed}
\caption{A simple Serpent program implementing a financial ``swap'' instrument, illustrating that smart contracts are a powerful and useful way to program with money.}
\end{figure}
...
The lab then proceeded in two phases as described below. 
...
they are revealed for the winner decision (Line 15 and 35-37).
...
\section{Conclusion}
We now summarize the outcomes and insights
attained from our smart contract programming lab.
