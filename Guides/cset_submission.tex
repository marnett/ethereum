...
\caption{{\bf Pitfall: contract leaks money in corner cases.}
...
\end{mdframed}
\label{fig:nocrypto}
\caption{{\bf Pitfall: failure to use cryptography.}
In this buggy contract, players send their inputs 
...
\end{mdframed}
\label{fig:incentive}
\caption{{\bf Pitfall: incentive compatibility.}
In this buggy contract, when one player opens its commitment,
