...
When an edge case ocurs, the contract refunds the players rather than leaking money (Lines 8 and 11). 
...
%In the first epoch, each player commits to an input choice (Line 5); in the second epoch, each player reveals the commited input (Line 26).
}
\end{figure*}
