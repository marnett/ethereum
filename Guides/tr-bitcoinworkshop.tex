...
Another mistake is failing to use cryptography appropriately to safeguard the necessary 
confidentiality and/or integrity guarantees.
...
In this paper, we will use a simple, hash-based commitment that satisfies 
the aforementioned security requirements assuming the random oracle
model.
