...
whenever it receives a message (from a user or from another contract).
...
to illustrate smart contract programming, although the lessons apply more generally to other cryptocurrencies and smart contract systems as well. Therefore we only define as much Ethereum-specific terminology as needed to understand our examples. In particular, the built-in currency of Ethereum is called Ether, and 
...
Ethereum offers an expressive programming language
