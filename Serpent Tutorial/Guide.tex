...
Contracts not only can have ether (currency) sent to them (via msg.value), but they can also send ether themselves. Msg.value holds the amount of wei (a unit of ether) that was sent with the contract.
